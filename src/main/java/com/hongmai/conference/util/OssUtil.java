...
public class OssUtil {
    Logger log = LoggerFactory.getLogger(OssUtil.class);

    private final String bucket;
    private final MinioClient minioClient;

    public OssUtil(@Value("${minio.url}") String url,
    ...
    public void putObject(InputStream is, String object, String contentType) throws Exception {
        ...
        minioClient.putObject(PutObjectArgs.builder()
                ...
                .build());
        log.info("成功上传文件至云端 [" + object + "]，耗时 [" + (System.currentTimeMillis() - start) + " ms]");
    }
    ...
    public GetObjectResponse getObject(String object) throws Exception {
        ...
        GetObjectResponse response = minioClient.getObject(GetObjectArgs.builder()
                ...
                .object(object)
                .build());
        log.info("成功获取 Object [" + object + "]，耗时 [" + (System.currentTimeMillis() - start) + " ms]");
        return response;
    }
